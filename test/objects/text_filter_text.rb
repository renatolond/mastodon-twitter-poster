...
class TextFilterTest < ActiveSupport::TestCase
  ...
  test "should_filter_coming_from_mastodon? - allow list: spoiler contain words" do
    ...
    text_filter = TextFilter.new(user)
    assert_not text_filter.should_filter_coming_from_mastodon?("Oh, this is a bad word: broccoli!", "chocolate")
  end
  ...
  test "should_filter_coming_from_mastodon? - allow list: text contain words" do
    ...
    text_filter = TextFilter.new(user)
    assert_not text_filter.should_filter_coming_from_mastodon?("Oh, this is a good word: chocolate!", "")
  end
  ...
  test "should_filter_coming_from_mastodon? - block list: text partial match should be ignored" do
    ...
    text_filter = TextFilter.new(user)
    assert_not text_filter.should_filter_coming_from_mastodon?("Hey, mccartney! Lend me a hand, will ya?", "")
  end
  test "should_filter_coming_from_mastodon? - block list with phrase" do
    ...
    assert_not text_filter.should_filter_coming_from_mastodon?(%(Oh, earth. I love you\nand I hope we can be together), "")
  ...
  test "should_filter_coming_from_twitter? - allow list: contain words" do
    ...
    text_filter = TextFilter.new(user)
    assert_not text_filter.should_filter_coming_from_twitter?("Oh, this is a good word: chocolate!")
  end
  ...
  test "should_filter_coming_from_twitter? - block list: partial match should be ignored" do
    ...
    text_filter = TextFilter.new(user)
    assert_not text_filter.should_filter_coming_from_twitter?("Hey, mccartney! Lend me a hand, will ya?")
  end
end
