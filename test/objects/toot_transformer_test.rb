...
class TootTransformerTest < ActiveSupport::TestCase
  ...
  test "Transform a text with a username in it and it should be posted in full length" do
    ...
    assert_equal [expected_text, false], TootTransformer.new(140).transform(text, "https://masto.donte.com.br/@renatolond/1111111", "https://masto.donte.com.br/", "masto.donte.com.br")
  end
  ...
  test "Transform a text with no links and exactly 280 characters" do
    ...
    assert_equal [expected_text, false], TootTransformer.new(280).transform(text, "https://mastodon.xyz/@renatolond/1111111", "https://mastodon.xyz", "mastodon.xyz")
  end
  ...
  test "Regression: pi was being recognized as a URL" do
    ...
    assert_equal [expected_text, true], TootTransformer.new(280).transform(text, "https://mastodon.xyz/@renatolond/1111111", "https://mastodon.xyz", "mastodon.xyz")
  end
  ...
  test "Transform a text with one big link (still inside the 140 char because of twitter short link)" do
    ...
    assert_equal [expected_text, false], TootTransformer.new(140).transform(text, "https://mastodon.xyz/@renatolond/1111111", "https://mastodon.xyz", "mastodon.xyz")
  end
  ...
  test "Transform a text with one more than the max number of urls in it" do
    ...
    assert_equal [expected_text, true], TootTransformer.new(140).transform(text, "https://mastodon.xyz/@renatolond/1111111", "https://mastodon.xyz", "mastodon.xyz")
  end
  ...
  test "Transform text with emojis and make sure is below the limit" do
    ...
    assert_equal [expected_text, true], TootTransformer.new(280).transform(text, "https://masto.donte.com.br/@renatolond/1111111", "https://masto.donte.com.br", "masto.donte.com.br")
  end
  ...
  test "Remove all possible mentions for Twitter" do
    ...
    assert_equal [expected_text, false], TootTransformer.new(1000).transform(text, "https://masto.donte.com.br/@renatolond/1111111", "https://masto.donte.com.br", "masto.donte.com.br")
  end
