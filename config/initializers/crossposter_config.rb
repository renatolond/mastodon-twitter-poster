...
Rails.application.configure do
  ...
  config.x.domain = ENV.fetch("CROSSPOSTER_DOMAIN", nil)
  ...
  config.x.admin_fedi_address = ENV.fetch("CROSSPOSTER_ADMIN_FEDI_ADDRESS", nil)
  config.x.admin_fedi_at = ENV.fetch("CROSSPOSTER_ADMIN_FEDI_AT", nil)
